...
router.get(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id })
      .populate("user", ["name", "avatar"]) // includes the avatar via gravatar
      .then(profile => {
        if (!profile) {
...
router.post(
  ...
  (req, res) => {
    ...
    // Skils needed to be split into an array
    ...
    if (req.body.linkedin)
      profileFields.social.youtubelinkedin = req.body.linkedin;
